...
/* ─── Text Blur Reveal (21st.dev style) ─── */
...
export function GlowCard({
  ...
  return (
    ...
    >
      <div className="absolute -inset-px rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-500 bg-[radial-gradient(300px_circle_at_var(--mouse-x)_var(--mouse-y),rgba(0,131,68,0.2),transparent_70%)]" />
      {children}
    </div>
  );
}
