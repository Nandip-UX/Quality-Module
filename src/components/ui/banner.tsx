  ...
  return (
    <div className="relative isolate flex flex-col justify-between gap-3 overflow-hidden rounded-lg border border-green-600/15 bg-gradient-to-r from-lime-100/80 to-emerald-100/80 py-3 pl-4 pr-12 sm:flex-row sm:items-center sm:py-2">
          ...
          {learnMoreUrl && (
            <>
              ...
              <a
                href={learnMoreUrl}
                target="_blank"
                className="text-stone-700 underline transition-colors hover:text-black"
              >
                Learn more
              </a>
            </>
      ...
      <div className="flex items-center sm:-my-1">
        <button
          type="button"
          className="whitespace-nowrap rounded-md border border-green-700/50 px-3 py-1 text-sm text-stone-800 transition-colors hover:bg-green-500/10"
